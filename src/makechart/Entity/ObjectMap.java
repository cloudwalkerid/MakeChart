...
public class ObjectMap {
    ...
    private ObjectGeoJson objectGeoJson;
    ...
    public ObjectMap(String uid, String name, String desc, boolean editable) {
        this.uid = uid;
        this.name = name;
        this.desc = desc;
    ...
    public ObjectMap(String uid, String name, String sourceData, String desc, boolean editable,
            ObjectGeoJson objectGeoJson, List<ObjectRowFilter> objectRowFilters,
        ...
        this.desc = desc;
        this.editable = editable;
        this.objectGeoJson = objectGeoJson;
    ...
    public void setJsonObject(JSONObject object) {
        try {
            ...
            if (object.has("objectGeoJson") && object.get("objectGeoJson") != null) {
                this.objectGeoJson = new ObjectGeoJson();
                this.objectGeoJson.setJsonObject(object.getJSONObject("objectGeoJson"));
            }
    ...
    public JSONObject getJSONObject() {
        try {
            ...
            if (objectGeoJson == null) {
                object.put("objectGeoJson", (String) null);
            } else {
                object.put("objectGeoJson", objectGeoJson.getJSONObject());
            }
    ...
    /**
     * @return the objectGeoJson
     */
    public ObjectGeoJson getObjectGeoJson() {
        return objectGeoJson;
    }

    /**
     * @param objectGeoJson the objectGeoJson to set
     */
    public void setObjectGeoJson(ObjectGeoJson objectGeoJson) {
        this.objectGeoJson = objectGeoJson;
    }
...
//        String query = "SELECT ";
//        if (objectColumnFilter.getColumnFunction() == EnumSQLColumnFunction.NORMAL) {
//            query = query + objectColumnFilter.getNameColumn() + " , ";
//        } else if (objectColumnFilter.getColumnFunction() == EnumSQLColumnFunction.AVERAGE) {
//            query = query + " AVG(" + objectColumnFilter.getNameColumn() + ") , ";
//        } else if (objectColumnFilter.getColumnFunction() == EnumSQLColumnFunction.COUNT) {
//            query = query + " COUNT(" + objectColumnFilter.getNameColumn() + ") , ";
//        } else if (objectColumnFilter.getColumnFunction() == EnumSQLColumnFunction.SUM) {
//            query = query + " SUM(" + objectColumnFilter.getNameColumn() + ") , ";
//        }
